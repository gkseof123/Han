...
DROP USER kosta CASCADE;
CREATE USER kosta
IDENTIFIED BY oracle
ACCOUNT UNLOCK
DEFAULT  TABLESPACE USERS;
GRANT CONNECT, RESOURCE TO kosta;
CONN kosta/oracle


REM  Script:  creobjects.sql
REM   
...
INSERT INTO EMP VALUES
        (7654, '심정수', '타자',  7698,
        TO_DATE('28-SEP-1981', 'DD-MON-YYYY'), 1250, 1400, 40);
INSERT INTO EMP VALUES
        (7698, '선동렬',  '감독',   7839,
        TO_DATE('1-MAY-1981', 'DD-MON-YYYY'),  2850, NULL, 40);
INSERT INTO EMP VALUES
        (7782, '박명환',  '투수',   7839,
...
INSERT INTO DEPT VALUES (10, '두산', '서울');
INSERT INTO DEPT VALUES (20, '롯데',   '부산');
INSERT INTO DEPT VALUES (30, '기아',   '광주');
INSERT INTO DEPT VALUES (40, '삼성', '대구');
